...
*/
declare function dztest2<T extends ndarray = ndarray>( arrays: [ float64ndarray, float64ndarray, T, ndarray, float64ndarray, float64ndarray, float64ndarray, float64ndarray ] ): T;
