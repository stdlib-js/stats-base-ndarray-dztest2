...
var x = new Float64Vector( [ 4.0, 4.0, 6.0, 6.0, 5.0 ] );
var y = new Float64Vector( [ 3.0, 3.0, 5.0, 7.0, 7.0 ] );
...
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-normal@umd/browser.js"></script>
